...
export const researchPapers: ResearchPaper[] = [
  {
    id: "lunar-rover-design",
    title: "Final Project Option 3 Lunar Rover Design",
    authors: ["Jadyn Worthington"],
    venue: "NASA Aerospace Scholars Program",
    year: "2020",
    description:
      "I engineered ‘Odysseus,’ a lunar rover concept built to scout dangerous terrain, gather core samples, and help future astronauts map the Moon with confidence.",
    fullContent: [
      "I designed Odysseus to survive abrasive regolith, staggering temperature swings, and the communication delays that force a rover to make fast decisions on its own.",
      "The rover’s sealed chassis protects the warm electronics box, while nitinol mesh wheels flex over sharp rocks without deforming permanently. I paired the mobility system with a 360° LIDAR mast so Odysseus can scout hazards, stitch together navigation maps, and flag safe routes before humans arrive.",
      "The sampling suite is anchored by the Extractive Abrasion Drill (EAD). It cores into rock, captures pristine cylinders, and feeds them directly into MAC—the Mineral Analysis Computer that houses the spectrometer, microscopic imager, and CheMin-style diffraction tools. The APXS sits on the robotic arm, so every sample leaves with precise elemental data.",
      "Building the concept pushed me to coordinate multiple NASA centers on paper, define data handoffs, and outline how autonomy and manual overrides would trade off safety versus speed for future missions."
    ].join("\n\n"),
    keyTakeaways: [
      "Mapped every subsystem down to dimensions, materials, and NASA center responsibilities so Odysseus could be manufactured and assembled collaboratively.",
      "Balanced autonomy and astronaut control by combining LIDAR, machine learning, and emergency teleoperations plans.",
      "Designed MAC to move samples seamlessly between spectrometer, microscopic imager, and diffraction analysis for rapid science returns."
    ],
    paperText: `Final Project Option 3 Lunar Rover Design
Jadyn Worthington
NASA 2020
...
Shoot for the moon. (n.d.). Retrieved February 19, 2021, from https://www.design-engineering.com/features/odg-lunar-rover-1004028325/
Rover body. (n.d.). Retrieved February 19, 2021, from https://mars.nasa.gov/mars2020/spacecraft/rover/body/
Rover wheels. (n.d.). Retrieved February 19, 2021, from https://mars.nasa.gov/mars2020/spacecraft/rover/wheels/
The Apollo Lunar Roving Vehicle. (n.d.). Retrieved February 19, 2021, from https://nssdc.gsfc.nasa.gov/planetary/lunar/apollo_lrv.html
Synecticadmin. (2021, February 15). Everything you need to know about nitinol - product development guide. Retrieved February 19, 2021, from https://synectic.net/everything-you-need-to-know-about-nitinol/
US Department of Commerce, N. (2012, October 01). What is lidar? Retrieved February 19, 2021, from https://oceanservice.noaa.gov/facts/lidar.html#:~:text=Lidar%2C%20which%20stands%20for%20Light,variable%20distances)%20to%20the%20Earth.
Rock abrasion Tool (RAT). (n.d.). Retrieved February 19, 2021, from https://mars.nasa.gov/mer/mission/instruments/rat/#:~:text=The%20Rock%20Abrasion%20Tool%20on,by%20the%20rover's%20scientific%20tools.
CheMin. (2020, April 22). Retrieved February 19, 2021, from https://mars.nasa.gov/msl/spacecraft/instruments/chemin/
`
  },
  {
    id: "atomic-layer-etching",
    title: "Advancing Material Science in Microelectronics through Atomic Layer Etching (ALE)",
    authors: ["Jadyn Worthington"],
    ...
    image: "/achievements/Jwor_Research%20Summer%202023.pptx.png",
    fullContent: [
      ...
      "The project taught me how to compare ALE cycles against traditional wet etch methods, document assumptions in lab notebooks, and brief faculty on how the improved traceability cut review time in half."
    ].join("\n\n"),
    keyTakeaways: [
...
export const articles: Article[] = [
  {
    id: "nasa-stem-program",
    title: "How did the NASA STEM Program trigger curiosity and keep Jadyn Worthington on track?",
    publication: "York College / CUNY",
    date: "2024",
    description:
      "York College/CUNY profiled my journey from a 10-year-old NASA-SEMAA participant to a University of Delaware computer science major focused on AI, ML, and robotics.",
    link: "https://www.york.cuny.edu/news/2024/how-did-the-nasa-stem-program-trigger-curiosity-and-keep-jadyn-worthington-on-track",
    author: "Nazrul Khandaker",
    image: "/achievements/jadynwor_CUNY.png"
  }
];

export const awards: Award[] = [
  {
    id: "outstanding-rso-leader",
    title: "Outstanding RSO Leader",
    organization: "University of Delaware - YoUDee Leadership Awards",
    date: "May 2024",
    description:
      "I was recognized as Outstanding RSO Leader for driving campus engagement, founding Men of Distinction, and collaborating across organizations to host inclusive, high-impact events.",
    category: "Leadership",
    image: "/achievements/mod1%20(1).jpeg",
    gallery: [
      "/achievements/mod1%20(1).jpeg",
      "/achievements/mod1%20(2).jpeg"
    ],
    fullContent:
      "The award celebrates the leadership I brought to Men of Distinction and partner groups on campus. I built programs that brought first-year and upperclass students together, worked with faculty advisors to keep momentum, and made sure every event centered care, mentorship, and consistent follow-through."
  }
];
